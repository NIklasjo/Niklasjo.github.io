                   ...
                   document.addEventListener('DOMContentLoaded', function () {
                     ...
                     const stations = [
                       { siteId: 1550, name: 'Sickla kaj', allowedDestinations: ["Solna station"], shortColor: "#ff7f00" },
                       { siteId: 9189, name: 'Gullmarsplan', allowedDestinations: ["Alvik", "Hässelby strand", "Vällingby"], shortColor: "#148541" },
                       { siteId: 9001, name: 'T-centralen', allowedDestinations: ["Hjulsta"], shortColor: "#007ac2" }
                     ];
