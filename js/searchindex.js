...
function SearchDatabase()
{
   ...
   this[database_length++] = new SearchPage("Tjänster-inom-bygg-och-projektledning-–-Stockholm-och-Uppsala.html", "Tjänster inom bygg och projektledning – Stockholm & Uppsala", "Copyright © 2024 KNS Consulting AB  All Rights Reserved   ", "Professionella tjänster inom bygg- och projektledning från KNS Consulting AB.");
   this[database_length++] = new SearchPage("Expert-i-Google-Sheets-och-Excel-för-Anpassade-Affärslösningar-och-Problem.html", "Google Sheets Lösningar & Excel Expertis | KNS AB", "Copyright © 2024 KNS Consulting AB  All Rights Reserved   ", "KNS Consulting AB erbjuder skräddarsydda lösningar i Google Sheets Lösningar och Excel Expertis");
   this[database_length++] = new SearchPage("Google-Sheets-Projekt--Fakturering,-Orderhantering,-CRM.html", "Google Sheets Projekt: Faktureringssystem Orderhantering CRM", "Copyright © 2024 KNS Consulting AB  All Rights Reserved   ", "Effektiva Google Sheets Projekt-lösningar, faktureringssystem, CRM och orderhantering av KNS AB.");
   return this;
}
